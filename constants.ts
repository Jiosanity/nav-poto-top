  ...
  if (language === 'zh') {
    return [
      ...
      },
      {
        ...
        title: '工具',
        links: [
          { id: 'l4', title: 'Canva', url: 'https://www.canva.cn/' },
          { id: 'l5', title: 'Unsplash', url: 'https://unsplash.com/' },
          { id: 'l6', title: 'CloudFlare', url: 'https://dash.cloudflare.com/login?lang=zh-hans-cn' },
          { id: 'l7', title: 'spaceship', url: 'https://www.spaceship.com/zh/auth/?returnUrl=%2Fcart%2Fdetails%2F' },
        ],
      },
      {
        id: 'c3',
        title: '社交',
        links: [
          { id: 'l8', title: '哔哩哔哩', url: 'https://www.bilibili.com/' },
          { id: 'l9', title: 'Twitter', url: 'https://twitter.com' },
        ],
      },
    ];
  }
